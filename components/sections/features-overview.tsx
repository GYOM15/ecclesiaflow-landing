              ...
              >
                ...
                <div className="group relative max-w-md w-full cursor-pointer">
                  ...
                  <div className="relative bg-white rounded-xl p-6 lg:p-7 shadow-[0_1px_8px_-3px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_30px_-6px_rgba(99,102,241,0.12)] transition-all duration-500 hover:-translate-y-1 border border-slate-100 overflow-hidden">
                    ...
                    <div className="relative inline-flex items-center justify-center w-10 h-10 rounded-xl bg-indigo-50 mb-4 transition-all duration-500 group-hover:scale-110 group-hover:shadow-[0_4px_16px_-4px_rgba(59,130,246,0.25)]">
                      <feature.icon className="h-5 w-5 text-indigo-500 transition-transform duration-500 group-hover:rotate-[-6deg]" />
                    </div>
                    ...
                    <div className="relative inline-flex items-center gap-1.5 text-xs font-medium text-indigo-500 group-hover:gap-2.5 transition-all duration-300">
