  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-3">
        ...
        <span className="text-[10px] bg-slate-100 text-slate-600 px-2 py-0.5 rounded-full font-medium">86% moyen</span>
      </div>
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-3">
        ...
        <span className="text-[10px] bg-slate-100 text-slate-600 px-2 py-0.5 rounded-full font-medium">4 cette semaine</span>
      </div>
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-3">
        ...
        <span className="text-[10px] bg-slate-100 text-slate-600 px-2 py-0.5 rounded-full font-medium">✓ Protégé</span>
      </div>
      {[
...
export function FeaturesDetail() {
  return (
    <section className="py-16 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-14 space-y-20 lg:space-y-28">
