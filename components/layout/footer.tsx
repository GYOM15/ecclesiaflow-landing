    ...
    <footer className="relative">
      ...
      <div className="w-full overflow-hidden leading-none" aria-hidden="true">
        <svg
          ...
          fill="#0F172A"
        >
          <path d="M0,60 C480,120 960,0 1440,60 C1680,90 1800,40 1920,60 L1920,120 L0,120 Z" />
        </svg>
      </div>
            ...
            <div className="lg:pt-2">
              ...
              >
                <input
                  ...
                  className="flex-1 bg-slate-800 border border-slate-700 rounded-full px-4 py-2.5 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/40 focus:border-indigo-500/40 transition-colors"
                />
                <button
                  type="submit"
                  className="inline-flex items-center gap-1.5 bg-indigo-500 hover:bg-indigo-600 text-white px-5 py-2.5 rounded-full text-sm font-medium transition-colors cursor-pointer"
                >
                  S&apos;abonner
