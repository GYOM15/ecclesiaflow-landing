            ...
            <div className="hidden lg:flex items-center gap-1">
              {NAV_LINKS.map((link) => (
                <Link
                  ...
                  href={link.href}
                  className={cn(
                    "px-4 py-2 text-sm font-medium transition-colors duration-200 border-t-2",
                    pathname === link.href
                      ? "text-slate-900 border-indigo-500"
                      : "text-slate-900 border-transparent hover:text-indigo-600 hover:border-indigo-300"
                  )}
                >
                  {link.label}
                </Link>
